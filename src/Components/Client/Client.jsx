...
const Client = () => {
  const clientSays = [
    {
      id: 1,
      description:
        "This is the best product I have ever used! I highly recommend it to everyone.This is the best product I have ever used! I highly recommend it to everyone.This is the best product I have ever used! I highly recommend it to everyone.This is the best product I have ever used! ",
      name: "John Doe",
  ...
  return (
    <div className="container xl:max-w-screen-xl mx-auto">
      <SectionTitle title="What Our Clients Say's" mb="mb-11"></SectionTitle>
