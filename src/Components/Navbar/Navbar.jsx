  ...
  return (
    <div>
      ...
      <div className="navbar_top flex items-center justify-center bg-[#272343] h-[45px] w-full">
        <div className="container lg:max-w-screen-lg flex justify-between items-center">
          ...
          <div className="navbar_top_right flex items-center gap-6">
            ...
            <button>
              <Link className="flex items-centertext-sm text-white font-inter font-normal capitalize">
                <Info />
                Need Help
              </Link>
            </button>
      ...
      <div className="navbar_middle flex items-center justify-center bg-[#f0f2f3] w-full h-[84px]">
        <div className="container lg:max-w-screen-lg grid grid-cols-3 items-center">
          ...
          <div className="navbar_middle_right flex items-center gap-4">
            <button className="btn capitalize ml-15">
              <ShoppingCart /> Cart{" "}
      ...
      <div className="navbar_bottom flex items-center justify-center w-full h-[75px] bg-white border-b-[1px] border-[#e1e3e5]">
        <div className="container lg:max-w-screen-lg flex items-center justify-between">
